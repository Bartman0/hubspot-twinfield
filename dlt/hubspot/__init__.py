...
THubspotObjectType = Literal["company", "contact", "deal", "ticket", "product", "quote", "line_item"]
...
def hubspot(
    ...
    def line_items(
        api_key: str = api_key,
        include_history: bool = include_history,
        props: Sequence[str] = DEFAULT_LINE_ITEMS_PROPS,
        include_custom_props: bool = True,
    ) -> Iterator[TDataItems]:
        """Hubspot line_items resource"""
        yield from crm_objects(
            "line_item",
            api_key,
            include_history,
    ...
    return line_items, companies, contacts, deals, products, quotes, tickets
