...
def load_crm_objects_default_properties_only() -> None:
    """
    Loads CRM objects, reading only properties defined by the user.
    """
    ...
    # To read only default properties
    source.companies.bind(include_custom_props=False)
    source.contacts.bind(include_custom_props=False)
    source.deals.bind(include_custom_props=False)
    source.tickets.bind(include_custom_props=False)
    #source.products.bind(include_custom_props=False)
    source.quotes.bind(include_custom_props=False)
...
if __name__ == "__main__":
    ...
    load_crm_objects_default_properties_only()
